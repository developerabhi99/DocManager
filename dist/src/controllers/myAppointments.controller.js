...
export async function getPatientHistory(req, res) {
    ...
    try {
        ...
        const totalSpent = appointments.reduce((sum, apt) => {
            return sum + apt.transactions.reduce((transactionSum, trans) => {
...
export async function getDoctorsAndPatients(req, res) {
    const authUser = req.user;
    try {
...
//# sourceMappingURL=myAppointments.controller.js.map