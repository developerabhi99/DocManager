...
export async function getEmployeeSchedules(req: Request, res: Response) {
...
export async function upsertEmployeeSchedule(req: Request, res: Response) {
  const { userId } = req.params;
...
export async function deleteEmployeeSchedule(req: Request, res: Response) {
...
export async function getAllEmployeeSchedules(req: Request, res: Response) {
  const authUser: any = (req as any).user;
...
export async function createDefaultSchedule(req: Request, res: Response) {
  const { userId } = req.params;
  const authUser: any = (req as any).user;
...
export async function createDefaultSchedulesForAll(req: Request, res: Response) {
  const authUser: any = (req as any).user;
