...
import {
  getPatientMedicalReportGroups,
  getMedicalReportGroupById,
  createMedicalReportGroup,
  updateMedicalReportGroup,
  getMedicalReportById as getMedicalReportByIdService,
  updateMedicalReport as updateMedicalReportService,
  getPatientVisitHistory,
  getAllMedicalReportGroups
} from "../services/medicalReport.service.js";
...
export const getReportGroupDetails = async (req: Request, res: Response) => {
  try {
...
export const createReportGroup = async (req: Request, res: Response) => {
  try {
...
export const updateReportGroup = async (req: Request, res: Response) => {
  try {
    const { reportGroupId } = req.params;
...
export const updateMedicalReportEnhanced = async (req: Request, res: Response) => {
  try {
    const { reportId } = req.params;
    const { 
      diagnosis, 
    ...
    if (labResults !== undefined) updateData.labResults = labResults;
    if (imaging !== undefined) updateData.imaging = imaging;
    if (isReferred !== undefined) updateData.isReferred = isReferred;
    if (referredTo !== undefined) updateData.referredTo = referredTo;
...
export const getPatientVisitHistoryController = async (req: Request, res: Response) => {
  try {
    const { patientId } = req.params;
...
export const getAllReportGroups = async (req: Request, res: Response) => {
  try {
    const { 
      status, 
      patientId, 
