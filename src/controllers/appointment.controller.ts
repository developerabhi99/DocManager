...
export const listAppointments = async (req: Request, res: Response) => {
  try {
    ...
    const appointmentsWithReferralDetails = await Promise.all(
...
export const completeAppointment = async (req: MulterRequest, res: Response) => {
  try {
    const { appointmentId } = req.params;
...
export const createReferralAppointment = async (req: Request, res: Response) => {
  try {
...
export const referAppointment = async (req: Request, res: Response) => {
  try {
    const { appointmentId } = req.params;
