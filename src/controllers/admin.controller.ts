...
export async function listRoles(req: Request, res: Response) {
  ...
  const mapped = roles.map((r: any) => ({
    ...
    permissionIds: (r.permissions || []).map((rp: any) => rp.permission.id),
  }));
...
export async function listUserTypes(req: Request, res: Response) {
...
export async function createRole(req: Request, res: Response) {
  ...
  const ids: string[] = Array.isArray(permissionIds)
