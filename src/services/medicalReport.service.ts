...
export const getPatientMedicalReportGroups = async (patientId: string) => {
  try {
...
export const getMedicalReportGroupById = async (reportGroupId: string) => {
  try {
...
export const updateMedicalReportGroup = async (
...
export const getMedicalReportById = async (reportId: string) => {
  try {
